...
def train_data_load(img_rows=64, img_cols=64, color_type=3):
    ...
    for classes in tqdm(range(num_classes)):
        ...
        files = glob(
            os.path.join('C:\\Users\\Bonjour\\Etudes&Travail\\Projets\\Pycharm\\DeepLearningSafetyDrive\\Data\\train\\c' + str(classes),
                         '*.jpg'))
        for file in files:
...
def load_test(size=200000, img_rows=64, img_cols=64, color_type=3):
    ...
    """
    path = os.path.join('C:/Users/Bonjour/Etudes&Travail/Projets/PyCharm/DeepLearningSafetyDrive/Data/test', '*.jpg')
