...
def main():
    ...
    sampleClassificationReport = """              precision    recall  f1-score   support
           ...
           safe-driving       1.00      0.94      0.97       506
           texting-right       0.98      1.00      0.99       433
           talking-on-the-phone-right       0.99      0.97      0.98       482
           texting-left       0.95      1.00      0.98       422
           talking-on-the-phone-left       1.00      0.97      0.99       475
           operating-the-radio       1.00      1.00      1.00       477
           drinking       0.99      0.97      0.98       445
           reaching-behind       0.99      0.99      0.99       394
           hair-and-makeup       0.96      0.97      0.97       377
           talking-to-passenger       0.93      0.99      0.96       473
...
weighted avg       0.98      0.98      0.98      4484"""
    ...
    plt.savefig(
        "test_plot_classif_report.png", dpi=200, format="png", bbox_inches="tight"
    )
    plt.close()
